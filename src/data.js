...
const reviews = [
  {
    ...
    image: "https://i.ibb.co/W0kkrdS/Sajid-Images.jpg",
    text: "As a passionate software engineer, I am driven by my unwavering commitment to designing and developing cutting-edge software solutions. With a keen eye for detail and a deep love for problem-solving, I thrive in creating efficient, scalable, and user-centric applications that push the boundaries of what technology can achieve. My work is a testament to my dedication to staying at the forefront of industry trends and my relentless pursuit of excellence in every project I undertake.",
  },
  {
    id: 1,
    name: "Pranay Gupta",
